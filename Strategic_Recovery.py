...
with tabs[2]:
    ...
    st.dataframe(vend_df.style.highlight_max(subset=['Capital_Drag_bps'], color='#ff4b4b'))
...
with tabs[3]:
    ...
    st.plotly_chart(px.choropleth(geo_df, locations='State', locationmode="USA-states", color='Exceptions', scope="usa", color_continuous_scale="Reds"))
